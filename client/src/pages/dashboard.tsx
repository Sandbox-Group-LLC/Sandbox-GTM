            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="border-2">
                ...
                <CardContent>
                  <div className="space-y-2">
                    <div>
                      <p className="text-lg lg:text-2xl font-bold" data-testid="text-total-conversions">{analytics?.attendance.total || 0}</p>
                    ...
                    <div className={`flex items-center gap-1 ${
                      ...
                      {milestoneStatus?.status === "on_track" && <TrendingUp className="w-4 h-4" />}
                      {milestoneStatus?.status === "at_risk" && <AlertTriangle className="w-4 h-4" />}
                      {milestoneStatus?.status === "behind" && <TrendingDown className="w-4 h-4" />}
                      {milestoneStatus?.status === "achieved" && <CheckCircle className="w-4 h-4" />}
                      {milestoneStatus?.status === "no_data" && <Minus className="w-4 h-4" />}
                      {!milestoneStatus && <Minus className="w-4 h-4" />}
                      <span className="text-xs font-medium">{milestoneStatus?.statusLabel || "No data"}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <div className="space-y-2">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">Check-in rate</p>
                    </div>
              ...
              <Card className="border-2">
                ...
                <CardContent>
                  <div className="space-y-2">
                    <div>
                      <p className="text-lg lg:text-2xl font-bold" data-testid="text-budget-spent">${analytics?.budget.totalSpent.toLocaleString() || 0}</p>
                      <p className="text-xs text-muted-foreground mt-1">Investment to date</p>
                    </div>
                    <div className="flex items-center gap-1 text-muted-foreground">
                      <Target className="w-4 h-4" />
                      <span className="text-xs font-medium">{analytics?.budget.utilizationRate || 0}% used</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-2">
                ...
                <CardContent>
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-1 text-muted-foreground">
                      <span className="text-xs font-medium" data-testid="text-nps-breakdown">
